...
ActiveRecord::Schema.define(version: 2020_07_07_063150) do
  ...
  create_table "backup_quotas", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "server"
  ...
  create_table "bandwidth_quotas", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "bgp_sessions", id: :integer, charset: "utf8", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "bgp_sessions_prefixes", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "charges", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "credit_cards", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "hosts", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "invoices_line_items", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "invoices_payments", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "ip_blocks", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "pools", id: :integer, charset: "utf8", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    t.string "pool_type"
  ...
  create_table "sales_receipts", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "account_id", null: false
    t.text "sold_to"
    t.date "date"
    t.text "message"
  ...
  create_table "sales_receipts_line_items", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "service_codes", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "ssh_host_keys", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "virtual_machine_id"
    t.text "key"
  ...
  create_table "ssh_keys", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "virtual_machines", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "virtual_machines_interfaces", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "virtual_machine_id"
  ...
  create_table "vlans", id: :integer, charset: "utf8", force: :cascade do |t|
